...
impl MockEngineArgs {
    ...
    fn new(
        ...
        let mut builder = RsMockEngineArgs::builder()
            ...
            .hybrid_mamba_groups(hybrid_mamba_groups)
            .hybrid_mamba_states_per_group(hybrid_mamba_states_per_group)
    ...
    #[getter]
    fn hybrid_mamba_groups(&self) -> usize {
        self.inner.hybrid_mamba_groups
    }

    #[getter]
    fn hybrid_mamba_states_per_group(&self) -> usize {
        self.inner.hybrid_mamba_states_per_group
    }
